...
private:
  typedef critical_point<number_type, size_type>        cp_type;
public:
  /**
...
//        size_type const num_dropped = _dropvec.size();
        if (dropped_begin == dropped_end) {
          ...
          std::cout << "DROPPED BEFORE FLOW TO INF\n";
